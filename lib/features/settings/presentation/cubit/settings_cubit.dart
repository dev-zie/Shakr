...
class SettingsCubit extends Cubit<SettingsState> {
  ...
  Future<void> _loadSettings() async {
    final sensitivity = await localStorageService.getSensitivity();
    emit(state.copyWith(shakeSensitivity: sensitivity));
  }
  ...
  Future<void> setSensitivity(ShakeSensitivity sensitivity) async {
    await localStorageService.setSensitivity(sensitivity);
    emit(state.copyWith(shakeSensitivity: sensitivity));
  }
